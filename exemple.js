...
function bufferFile(relPath) {
    token = fs.readFileSync(filePath,{ encoding: 'utf8' }); // zzzz....
}
...
// Aide pour le bot
var helpText = "```Liste des commandes\n";
helpText += " - " + prefix + "help  Affiche ce message d'aide\n";
helpText += " - " + prefix + "version  Affiche les informations de version du bot\n";
helpText += " - " + prefix + "debug  Active ou désactive le mode débug.\n";
helpText += "   Syntaxe : " + prefix + "debug true|false";
helpText += "   Debug activé : " + debugMode + "\n";
helpText += "```";

bot.on('ready', () => {
    console.log(new Date() + ' : Logged in as '+ bot.user.tag);
});
